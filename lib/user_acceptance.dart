...
class UserAcceptanceScreen extends StatelessWidget {
  const UserAcceptanceScreen({super.key});
                ...
                child: Stack(
                  children: [
                        ...
                        child: Stack(
                                    ...
                                    child: Stack(
                                      children: [
                                        Positioned(
                                          ...
                                          top: 3,
                                          height: 11.336,
                                          child: Image.asset('images/image_17460.png', width: 66.662, height: 11.336,),
                                        ),
                                        const Positioned(
                                          left: 0,
                                          width: 54,
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                ...
                                child: Image.asset('images/image_17475.png', width: 428, height: 76,)),
                            ),
                          ],
                        ),
                      ),
                    ...
                    Positioned(
                      ...
                      top: 154,
                      height: 3,
                      child: Image.asset('images/image_17487.png', width: 384, height: 3,),
                    ),
                    Positioned(
                      left: 22,
                      width: 384,
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Image.asset('images/image_17492.png', width: 28, height: 28,),
                            ],
                          ),
                        ],
                      ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              Image.asset('images/image_17495.png', width: 81, height: 80,),
                            ],
                          ),
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  Column(
                                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                                    children: [
                                                                      Image.asset('images/image_17504.png', width: 22, height: 22,),
                                                                    ],
                                                                  ),
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  Column(
                                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                                    children: [
                                                                      Image.asset('images/image_17508.png', width: 22, height: 22,),
                                                                    ],
                                                                  ),
                                                                  const SizedBox(width: 4),
                                                                  const Column(
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Column(
                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                    children: [
                                                      Image.asset('images/image_17513.png', width: 22, height: 22,),
                                                    ],
                                                  ),
                                                ],
                                              ),
                    ...
                    child: Row(
                      ...
                      children: [
                            ...
                            Row(
                              ...
                              children: [
                                Column(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  children: [
                                    Image.asset('images/image_17519.png', width: 22, height: 22,),
                                  ],
                                ),
                        ...
                        Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Image.asset('images/image_17524.png', width: 24, height: 24,),
                          ],
                        ),
                      ],
                    ),
                    ...
                    child: Row(
                      ...
                      children: [
                            ...
                            Row(
                              ...
                              children: [
                                Column(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  children: [
                                    Image.asset('images/image_17528.png', width: 22, height: 22,),
                                  ],
                                ),
                                const SizedBox(width: 12),
                                const Column(
                        ...
                        Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Image.asset('images/image_17533.png', width: 24, height: 24,),
                          ],
                        ),
                      ],
                    ),
